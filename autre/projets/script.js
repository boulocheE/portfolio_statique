...
{
	var ancienChoix = document.getElementById( 'p' + choixAvant );
	ancienChoix.style.display = 'none';

	var choixCompetence = document.getElementById( 'p' + apres );
	choixCompetence.style.display = 'block';

	var choixAvantMenu = document.getElementById( 'choix' + choixAvant );
	choixAvantMenu.style.color = 'rgba( 106,103,49, 0.5 )';

	var choixApresMenu = document.getElementById( 'choix' + apres );
